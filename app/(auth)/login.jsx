    ...
    <SafeAreaView className="bg-primary h-full">
      <View className='w-full justify-top min-h-[24vh] px-4 my-6'>
        <Image
            ...
            resizeMode="contain"
        />
        <Text className='text-white text-center text-3xl font-semibold mt-5'>Bem vindo de volta</Text>
        <FormField
          title="E-mail"
          value={form.email}
      ...
      <View className="justify-center pt-5 flex-row gap-2">
        ...
        <Link href={"/cadastro"} className="text-md font-semibold text-accent">Cadastre-se já!</Link>
      </View>

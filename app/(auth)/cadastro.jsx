    ...
    <SafeAreaView className="bg-primary h-full">
      <View className="w-full justify-top min-h-[24vh] px-4 my-6">
        <Image
          ...
          resizeMode="contain"
        />
        <Text className="text-white text-center text-2xl font-semibold mt-5 flex">
          Bem-vindo ao seu novo
          <Text className="text-accent font-bold text-3xl"> Hub </Text>
        </Text>
        <FormField
          title="Usuário"
          value={form.user}
        ...
        <View className="justify-center pt-5 flex-row gap-2">
          <Text className="text-md text-gray-100">Já tem uma conta?</Text>
